...
$a->currency = 'usd';												# Currencey to lend out (usd, eth, btc...)
$a->placeAboveLowestAsk = 1000000;									# Number of units to offer lending above the lowest ask, e.g. if the lowest ask is for 0.05 and placeAboveLowestAsk = 1,000,000 the bot will lend out at a rate where there are 1,000,000 units offered above the lowest ask
$a->minimumRate = 0.03;												# Rate to lend at will be set to this if calculated offer rate is below it
$a->periodSchedule = array(											# Number of days to lend by rate, e.g.
	...
	'0.07' => 5,													# all lending higher than the highest specified rate will be for the period of the highest specified rate, e.g.
	'0.08' => 10,													# if the highest specified rate is 0.1 => 30 lending more than 0.1 will be for a period of 30 days
	'0.09' => 14,
	'0.1'  => 30
);
$a->reportFile = 'usd-report.html';									# File path to save hourly funding report
